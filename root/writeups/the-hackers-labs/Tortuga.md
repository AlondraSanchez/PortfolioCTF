...
![Inspección de web mapa](../../assets/tortuga/SS3.png)
...
![Ataque de fuerza bruta](../../assets/tortuga/SS4.png)

Una vez dentro, la `Flag de Usuario` se encontraba fácilmente en el directorio personal.

![Acceso remoto y captura de primer flag](../../assets/tortuga/SS5.png)
...
![Uso de linpeas para encontrar vulnerabilidades](../../assets/tortuga/SS8.png)
...
![Escala de privilegios y obtención de flag root](../../assets/tortuga/SS9.png)
